...
static api_pipeline *
d3d12_create_pipeline(api_context *ctx, const api_pipeline_desc *desc)
{
...
static void
d3d12_bind_pipeline(api_context *ctx, api_pipeline *pipeline)
{
}
...
static void
d3d12_image_write_png(api_context *ctx, api_image *image, const char *filename)
{
}
...
d3d12_create_context(const program_options *options)
{
   ...
   ctx->has_mesh_shader = false; // TODO
   ctx->vram_usage = 0;
